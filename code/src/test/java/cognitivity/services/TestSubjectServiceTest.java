...
public class TestSubjectServiceTest {
    ...
    public void FullTest()throws Exception{
        ...
        TestSubject testSubject = new TestSubject("Simha Gora", "pipipp", "Queue", "some", "thing", "here", "email");
        ...
        TestSubject subject1 = service.createTestSubject(new TestSubject("Timon", "Cow", "Hakuna", "1987", "A guardian", "Same sex married", "email"));
        TestSubject subject2 = service.createTestSubject(new TestSubject("Pumba", "pig", "Matata", "1987", "A guardian", "Same sex married", "email"));
        TestSubject subject3 = service.createTestSubject(new TestSubject("Simba", "Lion", "Safari", "1987", "A king!", "Married? at least I think so?", "email"));
        TestSubject subject4 = service.createTestSubject(new TestSubject("Mufasa", "Lion", "Safari", "1987", "A dead king!", "Married to the ground (in which he ie burried)", "email"));
        TestSubject subject5 = service.createTestSubject(new TestSubject("Scar", "Lion", "Safari", "1987", "A false king!", "Married! to EVIL!", "email"));
