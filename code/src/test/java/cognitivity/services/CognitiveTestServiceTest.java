...
//TODO: check if we need to delete the created parameters from the DB at the end of the test.
    ...
    public void FullTest(){
        ...
        TestQuestion question1 = questionService.createTestQuestion("question1",1,5,"bla",block1,test,manager);
        TestQuestion question2 = questionService.createTestQuestion("question2",1,5,"bla2",block2,test,manager);
        TestQuestion question3 = questionService.createTestQuestion("question3",1,5,"bla3",block3,test,manager);
