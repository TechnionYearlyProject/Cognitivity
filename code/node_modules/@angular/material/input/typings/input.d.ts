...
export declare class MatInput extends _MatInputMixinBase implements MatFormFieldControl<any>, OnChanges, OnDestroy, DoCheck, CanUpdateErrorState {
    ...
    required: any;
    /** Input questionType of the element. */
    type: string;
    ...
    /** Make sure the input is a supported questionType. */
    protected _validateType(): void;

    /** Checks whether the input questionType is one of the types that are never empty. */
