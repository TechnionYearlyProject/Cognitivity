...
export declare abstract class TileStyler {
     ...
     * This method will be implemented by each questionType of TileStyler.
     * @docs-private
     */
    abstract setRowStyles(tile: MatGridTile, rowIndex: number, percentWidth: number, gutterWidth: number): any;
    /**
     * Calculates the computed height and returns the correct style property to set.
     * This method can be implemented by each questionType of TileStyler.
     * @docs-private
     */
...
/**
 * This questionType of styler is instantiated when the user passes in a fixed row height.
...
/**
 * This questionType of styler is instantiated when the user passes in a width:height ratio
...
/**
 * This questionType of styler is instantiated when the user selects a "fit" row height mode.
