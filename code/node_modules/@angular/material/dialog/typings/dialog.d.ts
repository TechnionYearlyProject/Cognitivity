import {BlockScrollStrategy, Overlay, OverlayContainer, ScrollStrategy} from "@angular/cdk/overlay";
...
export declare class MatDialog {
     ...
     * @param componentOrTemplateRef The questionType of component being loaded into the dialog,
